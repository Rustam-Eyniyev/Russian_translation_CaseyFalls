...
translate russian day1_stripped_at_the_hallways_38540e0b:
    ...
    "Ее разум сходил с ума от того, что она только что сделала, и она начинала осознавать, что под ее юбкой чувствуется легкость."
...
translate russian day1_stripped_at_the_hallways_a315ddb8:
    ...
    "Она надеялась, что сможет избежать лестниц и не забыть закрыть ноги, когда будет садиться."
...
translate russian day1_stripped_at_the_hallways_ff666221:
    ...
    "Коридор был заполнен учениками, которые шли на уроки."
...
translate russian day1_stripped_at_the_hallways_9ee73f7e:
    ...
    "Кейси присоединилась к толпе и вскоре заметила Амелию, которая звала её поторопиться."
...
translate russian day1_stripped_at_the_hallways_7e865cae:
    ...
    "Она ускорилась настолько, насколько это было возможно в толпе."
...
translate russian day1_stripped_at_the_hallways_f44ee91a:
    ...
    "Среди всей этой суеты она смутно почувствовала, как кто-то прошел мимо ее бедра."
...
translate russian day1_stripped_at_the_hallways_6ec6c847:
    ...
    "Затем она услышала хихиканье и бег."
...
translate russian day1_stripped_at_the_hallways_2a1bb6b7:
    ...
    "Она повернулась и увидела, что Кассандра убегает и машет чем-то в руке."
...
translate russian day1_stripped_at_the_hallways_336cd398:
    ...
    "Затем ей пришло в голову, что она чувствует что-то нехорошее."
...
translate russian day1_stripped_at_the_hallways_4bc8ab74:
    ...
    "Она посмотрела вниз и обнаружила, что ниже пояса была полностью обнажена!"
...
translate russian day1_stripped_at_the_hallways_6463b544:
    ...
    "Она на мгновение была сбита с толку, но затем закричала, осознав, что Кассандра воспользовалась застежкой-липучкой, сорвала юбку и убежала с ней."
...
translate russian day1_stripped_at_the_hallways_a34c49f0:
    ...
    "Она осталась полуобнаженная стоять в коридоре, прежде чем она почувствовала или осознала, что что-то произошло."
...
translate russian day1_stripped_at_the_hallways_2f77d0d1:
    ...
    "Крик заставил всех остановиться и посмотреть прямо на неё, и сразу же её окружили с насмешками."
...
translate russian day1_stripped_at_the_hallways_693b76e7:
    ...
    "Когда ее рука начала прикрывать обнаженную киску, её первой мыслью было как можно скорее вернуться в раздевалку, но её путь внезапно преградили десятки насмешливых учеников."
...
translate russian day1_stripped_at_the_hallways_dbc01f9d:
    ...
    Character("Ученик 1", color="#3db98d") "Хорошая задница!"
...
translate russian day1_stripped_at_the_hallways_5fb322f6:
    ...
    Character("Ученица 1", color="#06d619") "OMG, это самая волосатая пизда, которую я когда-либо видел!"
...
translate russian day1_stripped_at_the_hallways_47f44854:
    ...
    Character("Ученик 2", color="#5a8bbf") "Горячо."
...
translate russian day1_stripped_at_the_hallways_a351f0d6:
    ...
    Character("Ученик 3", color="#cd840e") "Да, детка, сними остальное!"
...
translate russian day1_stripped_at_the_hallways_12bdf39c:
    ...
    Character("Ученица 2", color="#963ae0") "Покажи нам всё, милая."
...
translate russian day1_stripped_at_the_hallways_f8c35a1c:
    ...
    Character("Ученица 3", color="#3937bf") "Там волос хватит для целого свитера."
...
translate russian day1_stripped_at_the_hallways_4e6fc673:
    ...
    Character("Ученик 4", color="#b38909") "О, ее рука закрывает всё. Я пропустила всё."
...
translate russian day1_stripped_at_the_hallways_c55c6545:
    ...
    "Пробежав через них Кейси вернулась в раздевалку."
...
translate russian day1_stripped_at_the_hallways_0e31a4a6:
    ...
    "Как только она вошла, она, рыдая, легла на скамейку."
...
translate russian day1_stripped_at_the_hallways_c2c4fa29:
    ...
    casey "Как это могло случиться? Как Кассандра может быть такой злой?"
...
translate russian day1_stripped_at_the_hallways_3ee359a6:
    ...
    casey "Что я ей сделала? Все это было подстроено?"
...
translate russian day1_stripped_at_the_hallways_5424d717:
    ...
    "Амелия вбежала в раздевалку и начала утешать Кейси."
...
translate russian day1_stripped_at_the_hallways_35f4b29c:
    ...
    amelia "Я не видела этого, но слышала, что произошло."
...
translate russian day1_stripped_at_the_hallways_f28be64d:
    ...
    amelia "Ох, позволь мне принести тебе полотенце или что-то в этом роде, и я посмотрю, есть ли у кого-нибудь запасная юбка."
...
translate russian day1_stripped_at_the_hallways_39b98135:
    ...
    amelia "Может быть, в бюро находок найдётся твой размер?"
...
translate russian day1_stripped_at_the_hallways_9ad909d7:
    ...
    casey "(О боже, нет! Бюро находок находится в офисе Бернстейн, и я не хочу объяснять всё это этой суке..)"
...
translate russian day1_stripped_at_the_hallways_6e901ee3:
    ...
    "Однако ее опасения почти реализовались, когда учительница вошла в раздевалку."
...
translate russian day1_stripped_at_the_hallways_17d82866:
    ...
    daly "Ты думаешь о том, что ты делаешь?"
...
translate russian day1_stripped_at_the_hallways_472ba0c9:
    ...
    daly "Ну, может быть, но почему на тебе нет нижнего белья?"
...
translate russian day1_stripped_at_the_hallways_77287730:
    ...
    "Кейси внезапно вспомнила правила из текста шантажиста и быстро попыталась придумать правдоподобное оправдание, кроме шантажа."
...
translate russian day1_stripped_at_the_hallways_a5e4feee:
    ...
    "На этом этапе было лучше держать свои тузы в рукаве, пока она не узнает, кто за всем этим стоит и о чем идет речь."
...
translate russian day1_stripped_at_the_hallways_7d9e7865:
    ...
    daly "Может, тебе стоит пойти и объяснить это директрисе Бернстайн?"
...
translate russian day1_stripped_at_the_hallways_bb2812bf:
    ...
    casey "Это достаточно унизительно. Не могли бы вы отпустить меня на этот раз? Обещаю, этого больше не повторится."
...
translate russian day1_stripped_at_the_hallways_58982d2f:
    ...
    "В этот момент дверь в раздевалку открылась, и вошла Кассандра, держа в руках юбку Кейси."
...
translate russian day1_stripped_at_the_hallways_eb4ab85f:
    ...
    cassandra "Я нашла это в коридоре. Я думаю, что кто-то знает, кому он принадлежит?"
...
translate russian day1_stripped_at_the_hallways_1803ab35:
    ...
    daly "Немедленно отдайте её Кейси, мисс Блоккато и вам троим лучше идти в класс."
...
translate russian day1_stripped_at_the_hallways_5b6bd591:
    ...
    "Кейси быстро выхватила юбку у Кассандры и застегнула ее на талии."
...
translate russian day1_stripped_at_the_hallways_5b5c4ac6:
    ...
    daly "Мисс Рейн, во время утреннего перемены отправляйтесь в бюро находок и найдите что-нибудь, что можно надеть под юбку, и мне лучше не слышать о никаких других ваших выходках до конца дня, иначе вы отправитесь в кабинет директора."
...
translate russian day1_stripped_at_the_hallways_8ee3f094:
    ...
    "Кейси опустила голову, явно смущенная таким вниманием, не говоря уже о том, что всего несколько мгновений назад она была полуобнажённой."
...
translate russian day1_stripped_at_the_hallways_1f7a1a9d:
    ...
    cassandra "Что, черт возьми, с тобой не так? Ты какая-то шлюха или что-то в этом роде?"
...
translate russian day1_stripped_at_the_hallways_1d7da692:
    ...
    cassandra "Это была безобидная шутка. Как, черт возьми, я должна была знать, что у тебя под юбкой нет ничего?"
...
translate russian day1_stripped_at_the_hallways_4165b9c3:
    ...
    casey "(Так что теперь это моя вина, что кто-то сорвал мою одежду в коридоре и оставил меня в таком положении?)"
...
translate russian day1_stripped_at_the_hallways_5d06fa5e:
    ...
    casey "Слушай, просто забудь об этом, Кассандра, хорошо?"
...
translate russian day1_stripped_at_the_hallways_54d38635:
    ...
    casey "Мы почти опаздываем на занятия, и я не хочу с тобой об этом говорить."
...
translate russian day1_stripped_at_the_hallways_ca9e2e35:
    ...
    cassandra "Но тебе нужно что-нибудь сделать с этим кустом, девочка. Черт возьми. Похоже, у тебя там прячется маленькое животное!"
...
translate russian day1_stripped_at_the_hallways_d9fa4ae7:
    ...
    "Кассандра засмеялась и пошла в другом направлении, в свой класс, в то время как Амелия и Кассандра продолжили свой путь."
...
translate russian day1_stripped_at_the_hallways_65e385dc:
    ...
    "К счастью, они всё сделали вовремя. Надеюсь, на этом всё закончилось."
...
translate russian day1_stripped_at_the_hallways_95c651fa:
    ...
    "Урок прошел без каких-либо дополнительных событий, и Кейси начала чувствовать себя немного спокойнее."
...
translate russian day1_stripped_at_the_hallways_7def2444:
    ...
    "Хотя она прекрасно понимала, что на ней нет трусиков, и единственное, что отделяло ее от еще одного эпизода публичного позора, - это дурацкая юбка, скрепленная хлипкой липучкой."
